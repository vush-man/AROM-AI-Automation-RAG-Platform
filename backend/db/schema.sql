...
-- Embeddings are generated by export_to_sqlite.py and stored in this DB.
...
-- Document chunks (populated by export_to_sqlite.py)
...
-- Embeddings linked to chunks (populated by export_to_sqlite.py)
